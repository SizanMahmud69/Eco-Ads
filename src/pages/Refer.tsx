...
export default function Refer() {
  ...
  const handleShare = async () => {
    const shareData = {
      title: 'Join Eco Ads',
      text: `Join me on Eco Ads and earn points! Use my referral code: ${referralCode}`,
          ...
          <CardContent className="p-8 flex flex-col items-center text-center space-y-4">
            ...
            <div className="flex gap-2 w-full max-w-xs">
              ...
              <Button 
                onClick={handleShare}
                variant="secondary" 
                className="flex-1 font-bold gap-2 bg-white/10 hover:bg-white/20 text-white border-white/20"
              >
                <Share2 size={18} />
                Share
              </Button>
