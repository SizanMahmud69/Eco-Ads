...
import { Home, Disc, Eraser, ListChecks, Wallet, Settings, LogOut, User as UserIcon, Leaf, Zap, Users, User, Calculator, Brain, ShieldCheck, Palette, Eye, Loader2, AlertTriangle } from 'lucide-react';
  ...
  if (maintenance) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-6 text-center">
        ...
        <div className="w-full max-w-xs p-4 bg-white rounded-2xl border border-slate-200 shadow-sm">
    ...
    <AuthProvider>
      <Router>
        <Routes>
          ...
          <Route path="/number-memory" element={<PrivateRoute><Layout><NumberMemory /></Layout></PrivateRoute>} />
